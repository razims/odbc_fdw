...
assertions=(
    ...
    type_matrix_nulls import_type_matrix case_names sql_query money_text money_numeric charset_matrix wide_decimal wide_decimal_scale0 scripts parameter_in_out
    large_value rescan
)
